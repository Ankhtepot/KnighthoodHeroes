...
List<KnighthoodHero> get getHeroes {
  return [
    ...
    KnighthoodHero(
      ...
      EHeroType.rebel,
      EEnemyType.troll,
      'Chance to Burn with Base Power',
      Skill(
        'Furious Strike',
        ESkillClass.damage,
        chanceTo: ESkillDebuff.stun,
        ...
        description: 'Deals damage to enemies in front of you.',
      ),
      Skill(
        'Brutal Wave',
        ESkillClass.damage,
    ...
    KnighthoodHero(
      ...
      EHeroType.valiant,
      EEnemyType.beast,
      'Chance to Focus with Base Power',
      Skill(
        'Fey Gift',
        ESkillClass.heal,
        chanceTo: ESkillDebuff.regenerate,
    ...
    KnighthoodHero(
      ...
      EHeroType.rebel,
      EEnemyType.troll,
      '+30% critical chance for Warrior Heroes',
      Skill(
        'Reckless Charge',
        ESkillClass.damage,
        chanceTo: ESkillDebuff.none,
        ...
        description: 'Deals damage to one enemy on the back row. You take 20% of the total damage.',
      ),
      Skill(
        'Indominable Will',
        ESkillClass.healAndDamage,
    ...
    KnighthoodHero(
      ...
      Skill(
        ...
        description: 'Distributes damage across all enemies. Restores your health or armor by the same amount.',
      ),
    ),
    KnighthoodHero(
      'Viktor',
      ...
      EHeroType.maverick,
      EEnemyType.undead,
      'Increase damage of Undead Minions by 20%',
      Skill(
        'Psychic Shock',
        ESkillClass.damage,
        chanceTo: ESkillDebuff.expose,
        ...
        description: 'Deals damage to enemies in front of you and ignore armor.',
      ),
      Skill(
        'Mental Heal',
        ESkillClass.heal,
    ...
    KnighthoodHero(
      ...
      Skill(
        ...
        description: 'Distributes damage across all enemies. You take 16% of the total damage to your health.',
      ),
    ),
    KnighthoodHero(
      'Wei Feng',
    ...
    KnighthoodHero(
      ...
      EHeroType.logical,
      EEnemyType.militia,
      'Chance ot Protect with Base Power',
      Skill(
        'Harden Armor',
        ESkillClass.heal,
        chanceTo: ESkillDebuff.none,
    ...
    KnighthoodHero(
      ...
      Skill(
        ...
        description: 'Deals damage to one enemy on the back row. Restores your health or armor by the same amount.',
      ),
      Skill(
        'Toad Bomb',
        ESkillClass.damage,
    ...
    KnighthoodHero(
      ...
      EHeroType.champion,
      EEnemyType.golem,
      'Chance to Focus with Rage Power',
      Skill(
        'Cryo Spear',
        ESkillClass.damage,
        chanceTo: ESkillDebuff.freeze,
        ...
        description: 'Deals damage to enemies in the back row. Chance to freeze one enemy.',
      ),
      Skill(
        'Healing Visage',
        ESkillClass.heal,
        ...
        description: 'Restores health and armor.',
      ),
    ),
  ];
}
